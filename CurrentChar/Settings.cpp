...
void Settings::saveToFile() {
    ...
    for (Settings::Character& source : characters) {
        ...
        json_object_set_string(sourceObject, "sourceName", source.sourceName.c_str());
...
void Settings::readFromFile() {
	...
	for (size_t i = 0; i < json_array_get_count(sourcesArray); i++) {
        ...
        character.charName = json_object_get_string(sourceObject, "charName");
        character.sourceName = json_object_get_string(sourceObject, "sourceName");
